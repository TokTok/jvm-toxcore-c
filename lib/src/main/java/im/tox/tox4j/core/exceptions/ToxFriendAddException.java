...
public final class ToxFriendAddException extends ToxException {
  public enum Code {
     ...
     * friend that is already on the friend list. To resend a friend request,
     * first remove the friend, and then call addFriend again.
     */
    ALREADY_SENT,
    /**
    ...
    OWN_KEY,
    /**
     * The friend was already on the friend list, but the noSpam value was
     * different.
     */
    SET_NEW_NOSPAM,
    /**
     * The length of the friend request message exceeded {@link
