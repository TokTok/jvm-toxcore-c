 ...
 * disconnected, a client may choose to call [[ToxCore.bootstrap]] again, to reconnect to the DHT.
 * Note that this state may frequently change for short amounts of time. Clients should therefore
