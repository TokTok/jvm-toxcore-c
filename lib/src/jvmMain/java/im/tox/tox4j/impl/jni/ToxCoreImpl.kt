...
final class ToxCoreImpl(val options: ToxOptions) : ToxCore {
    ...
    override fun conferenceNew(): ToxConferenceNumber =
        ToxConferenceNumber(ToxCoreJni.toxConferenceNew(instanceNumber))
    ...
    override fun groupIsConnected(groupNumber: ToxGroupNumber): Boolean =
        ToxCoreJni.toxGroupIsConnected(instanceNumber, groupNumber.value)

    override fun groupDisconnect(groupNumber: ToxGroupNumber): Unit =
        ToxCoreJni.toxGroupDisconnect(instanceNumber, groupNumber.value)

    override fun groupReconnect(groupNumber: ToxGroupNumber): Unit =
        ToxCoreJni.toxGroupReconnect(instanceNumber, groupNumber.value)

    override fun groupLeave(groupNumber: ToxGroupNumber, partMessage: ToxGroupPartMessage): Unit =
        ToxCoreJni.toxGroupLeave(instanceNumber, groupNumber.value, partMessage.value)

    override fun groupSelfSetName(groupNumber: ToxGroupNumber, name: ToxGroupName): Unit =
    ...
    override fun groupSelfSetStatus(groupNumber: ToxGroupNumber, status: ToxUserStatus): Unit =
    ...
    override fun groupSetTopic(groupNumber: ToxGroupNumber, topic: ToxGroupTopic): Unit =
    ...
    override fun groupGetPeerLimit(groupNumber: ToxGroupNumber): Int =
        ToxCoreJni.toxGroupGetPeerLimit(instanceNumber, groupNumber.value)
