...
interface ToxCore : Closeable {
   ...
   */
  fun <S> iterate(handler: ToxCoreEventListener<S>, state: S): S
  ...
  fun fileControl(friendNumber: ToxFriendNumber, fileNumber: Int, control: ToxFileControl): Unit
  ...
  fun fileSeek(friendNumber: ToxFriendNumber, fileNumber: Int, position: Long): Unit
  ...
  fun friendSendLossyPacket(friendNumber: ToxFriendNumber, data: ToxLossyPacket): Unit
   ...
   */
  // @Throws(ToxFriendCustomPacketException::class)
  fun friendSendLosslessPacket(friendNumber: ToxFriendNumber, data: ToxLosslessPacket): Unit
}
