...
public final class ToxFileControlException extends ToxException {
  public enum Code {
    /**
     * A {@link ToxFileControl#PAUSE} control was sent, but the file transfer
     * was already paused.
     */
    ALREADY_PAUSED,
    /**
     * A {@link ToxFileControl#RESUME} control was sent, but the file transfer
     * was paused by the other party. Only the party that paused the transfer
     * can resume it.
     */
    DENIED,
    /**
