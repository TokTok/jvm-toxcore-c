...
/**
 * See [[im.tox.tox4j.av.callbacks.audio.AudioReceiveFrameCallbackPlayback]] for why this
 * class exists.
 */
final class VideoReceiveFrameCallbackDisplay extends AutoTestSuite with ToxExceptionChecks {
